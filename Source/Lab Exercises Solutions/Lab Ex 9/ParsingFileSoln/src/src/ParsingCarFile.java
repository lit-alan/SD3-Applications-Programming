  ...
  public static void main(String[] args) {
    ...
    try     {
      ...
      while (in.ttype != StreamTokenizer.TT_EOF)     {
        ...
        //read second token (COUNTY OF CAR)
        in.nextToken();
      
        //read THIRD (year) FOURTH (County Code) AND FIFTH (Reg Num) tokens (REG NUMBER OF CAR)
        ...
        //read TWELVETH token (MILEAGE OF CAR)
        in.nextToken();  
